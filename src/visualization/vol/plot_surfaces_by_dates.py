...
def plot_surfaces_by_dates(data,
                           dates,
                           x_labels,
                           y_labels
                           ):
    ...
    for i, date in enumerate(dates):
        ...
        surf = ax.plot_surface(X, Y, surface, cmap=plt.get_cmap('Spectral_r'), linewidth=0, antialiased=False)  # cmap='Spectral' # cmap='coolwarm'
